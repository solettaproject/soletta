...
/**
 * @brief Read an uint8_t in storage
 *
 * @param name name of property. It will look for a file on filesystem with
 * this name
 * @param value value sets the buffer that will be read
 *
...
/**
 * @brief Read a boolean in storage
 *
 * @param name name of property. It will look for a file on filesystem with
 * this name
 * @param value value sets the buffer that will be read
...
/**
 * @brief Read an int32 in storage
 *
 * @param name name of property. It will look for a file on filesystem with
 * this name
 * @param value value sets the buffer that will be read
...
/**
 * @brief Read sol_irange struct in storage
 *
 * @param name name of property. It will look for a file on filesystem with
 * this name
 * @param value value sets the buffer that will be read
...
/**
 * @brief Read sol_drange struct in storage
 *
 * @param name name of property. It will look for a file on filesystem with
 * this name
 * @param value value sets the buffer that will be read
