...
{
    struct sol_i2c_shared *tmp, *shared = NULL;
    struct sol_i2c_dispatcher *dispatcher = NULL;
...
sol_i2c_open(uint8_t bus, enum sol_i2c_speed speed)
{
    ...
    i2c_shared->dispatcher.timer = NULL;
    i2c_shared->dispatcher.pending = NULL;
    i2c_shared->dispatcher.set_idx = 0;
    i2c_shared->dispatcher.retry = 0;
