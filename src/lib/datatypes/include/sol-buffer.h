...
/**
 * @brief Appends the buffer @c from in the end of @c buf,
 * reallocating if necessary.
 *
 * @param buf Destination buffer
 * @param from The buffer from where the data will be copied
 *
 * @return @c 0 on success, error code (always negative) otherwise
 */
int sol_buffer_append_buffer(struct sol_buffer *buf, const struct sol_buffer *from);
