...
#ifndef SOL_NO_API_VERSION
#define SOL_SOCKET_IP_OPTIONS_API_VERSION (1)  /**< compile time API version to be checked during runtime */
#endif
    /**
 ...
 */
struct sol_socket *sol_socket_new(const struct sol_socket_options *options);
