...
/**
 * @brief Converts a transport (@see sol_bt_transport) to a string.
 *
...
/**
 * @brief Converts string (@see sol_bt_transport) to a transport.
 *
 ...
 *
 * @return pointer to a pending scan session (@see sol_bt_stop_scan()) on
