 ...
 */
struct sol_oic_request *sol_oic_client_request_new(enum sol_coap_method_t method, struct sol_oic_resource *res);
 ...
 * @return A valid client request on success or @c NULL on errors.
 */
struct sol_oic_request *sol_oic_client_non_confirmable_request_new(enum sol_coap_method_t method, struct sol_oic_resource *res);
