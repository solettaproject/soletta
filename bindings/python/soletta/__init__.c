...
#define __PYX_HAVE__soletta____init__
#define __PYX_HAVE_API__soletta____init__
#ifdef _OPENMP
#include <omp.h>
#endif /* _OPENMP */
...
static const char *__pyx_f[] = {
  "bindings/python/soletta/__init__.py",
};
...
/* Module declarations from 'soletta.__init__' */
#define __Pyx_MODULE_NAME "soletta.__init__"
int __pyx_module_is_main_soletta____init__ = 0;

/* Implementation of 'soletta.__init__' */
static char __pyx_k_main[] = "__main__";
static char __pyx_k_test[] = "__test__";
static char __pyx_k_soletta[] = "soletta";
static PyObject *__pyx_n_s_main;
static PyObject *__pyx_n_u_soletta;
...
static __Pyx_StringTabEntry __pyx_string_tab[] = {
  ...
  {&__pyx_n_u_soletta, __pyx_k_soletta, sizeof(__pyx_k_soletta), 0, 1, 0, 1},
...
#if PY_MAJOR_VERSION < 3
PyMODINIT_FUNC initsoletta(void); /*proto*/
PyMODINIT_FUNC initsoletta(void)
#else
PyMODINIT_FUNC PyInit_soletta(void); /*proto*/
PyMODINIT_FUNC PyInit_soletta(void)
#endif
{
  ...
  #endif
  __Pyx_RefNannySetupContext("PyMODINIT_FUNC PyInit_soletta(void)", 0);
  ...
  #if PY_MAJOR_VERSION < 3
  __pyx_m = Py_InitModule4("soletta", __pyx_methods, 0, 0, PYTHON_API_VERSION); Py_XINCREF(__pyx_m);
  #else
  ...
  #endif
  if (__pyx_module_is_main_soletta____init__) {
    if (PyObject_SetAttrString(__pyx_m, "__name__", __pyx_n_s_main) < 0) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 1; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  }
  if (unlikely(__Pyx_SetPackagePathFromImportLib(NULL, __pyx_n_u_soletta) < 0)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 1; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  #if PY_MAJOR_VERSION >= 3
  {
    PyObject *modules = PyImport_GetModuleDict(); if (unlikely(!modules)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 1; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
    if (!PyDict_GetItemString(modules, "soletta")) {
      if (unlikely(PyDict_SetItemString(modules, "soletta", __pyx_m) < 0)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 1; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
    }
  }
  #endif
  /*--- Builtin init code ---*/
 ...
 */
  ...
  if (__pyx_m) {
    if (__pyx_d) {
      __Pyx_AddTraceback("init soletta.__init__", __pyx_clineno, __pyx_lineno, __pyx_filename);
    }
    Py_DECREF(__pyx_m); __pyx_m = 0;
  } else if (!PyErr_Occurred()) {
    PyErr_SetString(PyExc_ImportError, "init soletta.__init__");
  }
  __pyx_L0:;
  __Pyx_RefNannyFinishContext();
  #if PY_MAJOR_VERSION < 3
